A side project I have been working on to better understand FFTs, python, and the numerous python libraires. Still a WIP. 

Objective is to allow the user to specify anchors on the spectrogram. Then allow the user to change these anchors, expending and contracting the spectrum above abd below to compensate.
